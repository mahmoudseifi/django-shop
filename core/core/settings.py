...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-43a)4*25a0n10#qq5fe%k-=$v#o)*5r1ts&q^va2q5qxo6h-$g')
...
# Modify the token expiration setting
PASSWORD_RESET_TIMEOUT = int(timedelta(hours=48).total_seconds())